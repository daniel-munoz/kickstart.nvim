...
local on_attach = function(_, bufnr)
  ...
  nmap('gr', require('telescope.builtin').lsp_references, '[G
--]]
...
vim.keymap.set("n", "<leader>tt", ":lua require('nvterm.terminal').toggle 'horizontal'<CR>", {silent = true}) -- Toggle terminal
vim.keymap.set("n", "<leader>tf", ":lua require('nvterm.terminal').toggle 'float'<CR>", {silent = true}) -- Toggle terminal

-- keymaps for dap
vim.keymap.set("n", "<F5>", ":lua require('dap').continue()<CR>", {silent = true})
vim.keymap.set("n", "<F2>", ":lua require('dap').step_over()<CR>", {silent = true})
vim.keymap.set("n", "<F3>", ":lua require('dap').step_into()<CR>", {silent = true})
...
vim.keymap.set("n", "<leader>dB", ":lua require('dap').set_breakpoint(vim.fn.input('Breakpoint condition: '))<CR>", {silent = true})
-- vim.keymap.set("n", "<leader>dl", ":lua require('dap').set_breakpoint(nil, nil, vim.fn.input('Log point message: '))<CR>", {silent = true})
...
vim.keymap.set("n", "<leader>dg", ":lua require('dapui').toggle()<CR>", {silent = true})
vim.keymap.set("n", "<leader>dc", ":lua require('dap').disconnect()<CR>", {silent = true})
vim.keymap.set("n", "<leader>dx", ":lua require('dap').close()<CR>", {silent = true})

vim.keymap.set("n", "<M-1>", ":NvimTreeToggle<CR>") -- open file explorer
vim.keymap.set("n", "<M-2>", ":NvimTreeFindFile<CR>") -- open file explorer
vim.keymap.set("n", "<M-3>", ":AerialToggle!<CR>") -- open file explorer
vim.keymap.set("n", "<M-4>", ":AerialToggle<CR>") -- open file explorer
