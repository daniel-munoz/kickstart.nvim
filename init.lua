...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          end, { buffer = buf, desc = '[G]o to vertical [s]plit with [d]efinition' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      local parsers =
        { 'bash', 'c', 'diff', 'go', 'gomod', 'gosum', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'python', 'query', 'scala', 'vim', 'vimdoc' }
