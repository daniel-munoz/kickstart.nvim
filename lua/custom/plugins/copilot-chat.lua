return {
  {
    ...
    opts = {
      ...
      model = 'claude-4.6-sonnet', -- Default model to use, see ':CopilotChatModels' for available models (can be specified manually in prompt via $).
      ...
      selection = function(source)
        ...
        return select.selection(source)
      end,
